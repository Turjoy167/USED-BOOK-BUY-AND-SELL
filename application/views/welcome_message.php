    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6 ofsett-3">
                <p>&copy Plabon Banikt | 2022<br>
                Email : joybanik82@gmail.com</p>
                <div class="social-links">
                      <?= anchor("https://www.facebook.com/turjoybanik.tlc/", '<i class="fab fa-facebook ic"></i>',['title'=>'Facebook', 'target'=>'_blank']); ?>
                      <?= anchor("https://github.com/Turjoy167", '<i class="fab fa-github ic"></i>',
                      ['title'=>'gitHub', 'target'=>'_blank']); ?>
                      <?= anchor("https://www.instagram.com/turjoy_banik/", '<i class="fab fa-instagram"></i>', ['title'=>'Instagram', 'target'=>'_blank']); ?>
                </div>
            </div>
        </div>
    </div>
